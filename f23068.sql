...
,p_default_workspace_id=>12902074519355403202
,p_default_application_id=>23068
...
prompt APPLICATION 23068 - Neo4j_JSON Mobile
--
-- Application Export:
--   Application:     23068
--   Name:            Neo4j_JSON Mobile
--   Date and Time:   01:04 Monday November 23, 2015
--   Exported By:     ZACK_BILDERBACK2012@YAHOO.COM
--   Flashback:       0
...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,23068)
,p_owner=>nvl(wwv_flow_application_install.get_schema,'DATAMANAGEMENT')
,p_name=>nvl(wwv_flow_application_install.get_application_name,'Neo4j_JSON Mobile')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_23068')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'4A483B2021AC51D5EF2BE19D0805DF8E82D3BBF059F2F8D7EA61AE0E0E4ACEC6'
...
,p_authentication_id=>wwv_flow_api.id(17152172470948338701)
,p_application_tab_set=>0
,p_logo_image=>'TEXT:Neo4j_JSON Mobile'
...
,p_csv_encoding=>'Y'
,p_last_updated_by=>'ZACK_BILDERBACK2012@YAHOO.COM'
,p_last_upd_yyyymmddhh24miss=>'20151123010257'
...
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(17152143676639338642)
,p_name=>'Mobile Navigation Menu'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(17152173308751338712)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(17746781534210023589)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(18178604305710044877)
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(17152143395749338641)
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(17152143405938338641)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(17152143543555338641)
,p_plugin_type=>'REGION TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(17152172329316338699)
,p_icon_sequence=>200
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(17152172568652338704)
,p_name=>' Breadcrumb'
);
end;
/
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(17152143703771338643)
,p_theme_id=>51
,p_name=>'Dialog'
,p_is_popup=>true
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(17152143834828338647)
,p_theme_id=>51
,p_name=>'Page'
,p_is_popup=>false
,p_header_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17152143997773338648)
,p_page_template_id=>wwv_flow_api.id(17152143834828338647)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17152144042614338649)
,p_page_template_id=>wwv_flow_api.id(17152143834828338647)
,p_name=>'Header Bar'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17152144166199338649)
,p_page_template_id=>wwv_flow_api.id(17152143834828338647)
,p_name=>'Footer Bar'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(17152144638558338651)
,p_theme_id=>51
,p_name=>'Popup'
,p_is_popup=>false
,p_header_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(17152147088022338664)
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(17152171256482338668)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17152144778378338651)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17152144819427338654)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17152144901575338654)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17152145082436338655)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17152145108411338655)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17152145216748338655)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17152145320426338656)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17152145491707338656)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17152145561065338656)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17152145631232338656)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17152145712241338656)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17152145895170338656)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17152145984883338656)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17152146020273338657)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(17152146245878338659)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(17152146315613338661)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(17152146406807338661)
,p_list_template_current=>'<li data-theme="b"><a href="#LINK#">#TEXT_ESC_SC#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT_ESC_SC#</a></li>'
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(17152146590066338662)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(17152146631845338662)
,p_list_template_current=>'<li data-theme="b"><a href="#LINK#">#TEXT_ESC_SC#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT_ESC_SC#</a></li>'
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(17152146155896338657)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(17152146708631338662)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(17152146854974338664)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(17152146968878338664)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(17152171689690338670)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(17152171555273338669)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(17152172191738338677)
,p_theme_id=>51
,p_theme_name=>'Mobile'
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(17152143834828338647)
,p_default_dialog_template=>wwv_flow_api.id(17152143703771338643)
,p_error_template=>wwv_flow_api.id(17152143834828338647)
,p_printer_friendly_template=>wwv_flow_api.id(17152143834828338647)
,p_login_template=>wwv_flow_api.id(17152143834828338647)
,p_default_button_template=>wwv_flow_api.id(17152171256482338668)
,p_default_region_template=>wwv_flow_api.id(17152145895170338656)
,p_default_chart_template=>wwv_flow_api.id(17152145895170338656)
,p_default_form_template=>wwv_flow_api.id(17152145895170338656)
,p_default_reportr_template=>wwv_flow_api.id(17152146020273338657)
,p_default_tabform_template=>wwv_flow_api.id(17152145895170338656)
,p_default_wizard_template=>wwv_flow_api.id(17152145895170338656)
,p_default_irr_template=>wwv_flow_api.id(17152145895170338656)
,p_default_report_template=>wwv_flow_api.id(17152146155896338657)
,p_default_label_template=>wwv_flow_api.id(17152146854974338664)
,p_default_calendar_template=>wwv_flow_api.id(17152171555273338669)
,p_default_list_template=>wwv_flow_api.id(17152146406807338661)
,p_default_nav_list_template=>wwv_flow_api.id(17152146315613338661)
,p_default_top_nav_list_temp=>wwv_flow_api.id(17152146315613338661)
,p_default_side_nav_list_temp=>wwv_flow_api.id(17152146631845338662)
,p_default_nav_list_position=>'SIDE'
,p_default_dialogbtnr_template=>wwv_flow_api.id(17152144778378338651)
,p_default_dialogr_template=>wwv_flow_api.id(17152145895170338656)
,p_default_option_label=>wwv_flow_api.id(17152146854974338664)
,p_default_header_template=>wwv_flow_api.id(17152145561065338656)
,p_default_footer_template=>wwv_flow_api.id(17152145320426338656)
,p_default_required_label=>wwv_flow_api.id(17152146968878338664)
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(17152171798351338672)
,p_theme_id=>51
,p_name=>'Blue'
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(17152171893481338672)
,p_theme_id=>51
,p_name=>'Dark'
,p_css_file_urls=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(17152171904447338672)
,p_theme_id=>51
,p_name=>'Default'
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(17152172009640338672)
,p_theme_id=>51
,p_name=>'Red'
,p_css_file_urls=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(17152144285517338650)
,p_theme_id=>51
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(17152147177381338665)
,p_theme_id=>51
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(17152147981708338666)
,p_theme_id=>51
,p_name=>'ICON_BUTTON'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17152144324874338650)
,p_theme_id=>51
,p_name=>'OVERLAY'
...
,p_group_id=>wwv_flow_api.id(17152144285517338650)
,p_template_types=>'PAGE'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17152144406002338651)
,p_theme_id=>51
,p_name=>'PUSH'
,p_display_name=>'Push'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17152144504894338651)
,p_theme_id=>51
,p_name=>'REVEAL'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17152147202157338665)
,p_theme_id=>51
,p_name=>'ICON_BOTTOM'
,p_display_name=>'Bottom'
,p_display_sequence=>50
,p_button_template_id=>wwv_flow_api.id(17152147088022338664)
,p_css_classes=>'ui-btn-icon-bottom'
,p_group_id=>wwv_flow_api.id(17152147177381338665)
,p_template_types=>'BUTTON'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17152147324308338666)
,p_theme_id=>51
,p_name=>'ICON_LEFT'
,p_display_name=>'Left'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17152147412243338666)
,p_theme_id=>51
,p_name=>'NO_TEXT'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17152147589213338666)
,p_theme_id=>51
,p_name=>'ICON_RIGHT'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17152147600825338666)
,p_theme_id=>51
,p_name=>'ICON_TOP'
,p_display_name=>'Top'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17152147768858338666)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17152147863373338666)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17152168085909338666)
,p_theme_id=>51
,p_name=>'ICON_ACTION'
...
,p_group_id=>wwv_flow_api.id(17152147981708338666)
,p_template_types=>'BUTTON'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17152168105617338666)
,p_theme_id=>51
,p_name=>'ICON_ALERT'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17152168263642338666)
,p_theme_id=>51
,p_name=>'ICON_BACK'
,p_display_name=>'Back'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17152168375135338666)
,p_theme_id=>51
,p_name=>'ICON_BARS'
,p_display_name=>'Bars'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17152168452007338666)
,p_theme_id=>51
,p_name=>'ICON_BULLETS'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17152168518014338666)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17152168680001338666)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17152168781626338667)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17152168878042338667)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17152168910876338667)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17152169074474338667)
,p_theme_id=>51
,p_name=>'ICON_CHECK'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17152169108388338667)
,p_theme_id=>51
,p_name=>'ICON_CLOCK'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17152169296463338667)
,p_theme_id=>51
,p_name=>'ICON_CLOUD'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17152169354985338667)
,p_theme_id=>51
,p_name=>'ICON_COMMENT'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17152169497376338667)
,p_theme_id=>51
,p_name=>'ICON_DELETE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17152169513866338667)
,p_theme_id=>51
,p_name=>'ICON_EDIT'
,p_display_name=>'Edit'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17152169664805338667)
,p_theme_id=>51
,p_name=>'ICON_GEAR'
,p_display_name=>'Gear'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17152169763806338667)
,p_theme_id=>51
,p_name=>'ICON_GRID'
,p_display_name=>'Grid'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17152169846366338667)
,p_theme_id=>51
,p_name=>'ICON_HOME'
,p_display_name=>'Home'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17152169982782338667)
,p_theme_id=>51
,p_name=>'ICON_INFO'
,p_display_name=>'Info'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17152170025948338667)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17152170150083338667)
,p_theme_id=>51
,p_name=>'ICON_LOCK'
,p_display_name=>'Lock'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17152170295237338668)
,p_theme_id=>51
,p_name=>'ICON_MAIL'
,p_display_name=>'Mail'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17152170329244338668)
,p_theme_id=>51
,p_name=>'ICON_MINUS'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17152170432153338668)
,p_theme_id=>51
,p_name=>'ICON_PHONE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17152170563282338668)
,p_theme_id=>51
,p_name=>'ICON_PLUS'
,p_display_name=>'Plus'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17152170697710338668)
,p_theme_id=>51
,p_name=>'ICON_POWER'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17152170729076338668)
,p_theme_id=>51
,p_name=>'ICON_REFRESH'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17152170839333338668)
,p_theme_id=>51
,p_name=>'ICON_SEARCH'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17152170971005338668)
,p_theme_id=>51
,p_name=>'ICON_STAR'
,p_display_name=>'Star'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17152171098515338668)
,p_theme_id=>51
,p_name=>'ICON_TAG'
,p_display_name=>'Tag'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17152171106614338668)
,p_theme_id=>51
,p_name=>'ICON_USER'
,p_display_name=>'User'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17152171388920338668)
,p_theme_id=>51
,p_name=>'INLINE_BUTTON'
,p_display_name=>'Inline Button'
,p_display_sequence=>1
,p_button_template_id=>wwv_flow_api.id(17152171256482338668)
,p_css_classes=>'ui-btn-inline'
,p_template_types=>'BUTTON'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(17152171437711338668)
,p_theme_id=>51
,p_name=>'ROUNDED_CORNERS'
,p_display_name=>'Rounded Corners'
,p_display_sequence=>1
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(17152172470948338701)
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(17152172273033338687)
,p_ui_type_name=>'JQM_SMARTPHONE'
...
,p_global_page_id=>0
,p_navigation_list_id=>wwv_flow_api.id(17152143676639338642)
,p_navigation_list_position=>'SIDE'
,p_navigation_list_template_id=>wwv_flow_api.id(17152146631845338662)
...
wwv_flow_api.create_page(
 p_id=>0
,p_user_interface_id=>wwv_flow_api.id(17152172273033338687)
...
,p_last_upd_yyyymmddhh24miss=>'20151117035833'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(17152172852338338706)
,p_plug_name=>'Header'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(17152145561065338656)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(17152173188800338708)
,p_plug_name=>'Footer'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(17152145320426338656)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(17152173087815338708)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(17152172852338338706)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(17152172960258338707)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(17152173213994338708)
,p_name=>'open panel'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(17152172960258338707)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(17152173213994338708)
,p_event_id=>wwv_flow_api.id(17152173213994338708)
,p_event_result=>'TRUE'
...
,p_last_updated_by=>'ZACK_BILDERBACK2012@YAHOO.COM'
,p_last_upd_yyyymmddhh24miss=>'20151121202517'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(18042515769747123215)
,p_plug_name=>'New'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(17152145895170338656)
,p_plug_display_sequence=>10
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18042515845174123216)
,p_name=>'WELCOME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(18042515769747123215)
,p_prompt=>'Welcome'
,p_source=>'http://www.whitewaterfreight.com/wp-content/uploads/sites/396/2014/10/welcome_friends.jpg'
,p_source_type=>'STATIC'
,p_display_as=>'NATIVE_DISPLAY_IMAGE'
,p_new_grid=>true
,p_field_template=>wwv_flow_api.id(17152146854974338664)
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'ZACK_BILDERBACK2012@YAHOO.COM'
,p_last_upd_yyyymmddhh24miss=>'20151121215605'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(17746489769430849019)
,p_plug_name=>'doREST'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(17152145895170338656)
,p_plug_display_sequence=>10
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(17746508000933849038)
,p_plug_name=>'Results'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(17152146020273338657)
...
wwv_flow_api.create_flash_chart5(
 p_id=>wwv_flow_api.id(18042517081626123228)
,p_default_chart_type=>'3DColumn'
,p_chart_title=>'Results'
...
wwv_flow_api.create_flash_chart5_series(
 p_id=>wwv_flow_api.id(18042517119990123229)
,p_chart_id=>wwv_flow_api.id(18042517081626123228)
,p_series_seq=>10
,p_series_name=>'Graph'
,p_series_query=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'select null link,	',
'jt1.product_name product_name,		',
'jt2.list_price list_price',
'',
'from apex_collections t,',
'json_table(t.clob001, ''$.PRODUCT_NAME[*]'' COLUMNS rid for ordinality, product_name	varchar2(255) path ''$'')	jt1,	',
'json_table(t.clob001, ''$.LIST_PRICE[*]'' COLUMNS	rid	for	ordinality,	list_price number path ''$'') jt2',
'',
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(17746490156773849020)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(17746489769430849019)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(17746490573601849021)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17746491359684849024)
,p_name=>'P2_DB'
,p_item_sequence=>1
,p_item_plug_id=>wwv_flow_api.id(17746489769430849019)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17746492157585849028)
,p_name=>'P2_USER'
,p_item_sequence=>2
,p_item_plug_id=>wwv_flow_api.id(17746489769430849019)
,p_item_default=>'C##cs347_zdb248'
,p_prompt=>'User'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_cMaxlength=>255
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17746492947846849029)
,p_name=>'P2_PASS'
,p_item_sequence=>3
,p_item_plug_id=>wwv_flow_api.id(17746489769430849019)
,p_item_default=>'orcl_zdb248'
,p_prompt=>'Pass'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_cMaxlength=>255
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17746493753893849030)
,p_name=>'P2_MODE'
,p_item_sequence=>4
,p_item_plug_id=>wwv_flow_api.id(17746489769430849019)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17746494559162849031)
,p_name=>'P2_MODEL'
,p_item_sequence=>5
,p_item_plug_id=>wwv_flow_api.id(17746489769430849019)
,p_item_default=>'F6'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17746495342582849031)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17746496138592849032)
,p_name=>'P2_RETURNFOR'
,p_item_sequence=>7
,p_item_plug_id=>wwv_flow_api.id(17746489769430849019)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17746496997421849033)
,p_name=>'P2_QUERY'
,p_item_sequence=>8
,p_item_plug_id=>wwv_flow_api.id(17746489769430849019)
,p_item_default=>'"MATCH (a:product) RETURN a.product_name, a.list_price"'
,p_prompt=>'Query'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_cMaxlength=>255
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(17746490977810849021)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_WEB_SERVICE'
,p_process_name=>'Web Service Request'
,p_process_sql_clob=>'17152289909664350965:17152290183765350977'
,p_attribute_01=>wwv_flow_api.id(17152290183765350977)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(18178645618106048094)
,p_plug_name=>'doREST'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(17152145895170338656)
,p_plug_display_sequence=>10
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(18178653829729048108)
,p_name=>'Results'
,p_template=>wwv_flow_api.id(17152146020273338657)
,p_display_sequence=>20
,p_include_in_reg_disp_sel_yn=>'N'
,p_region_template_options=>'#DEFAULT#'
...
'--where	collec1on_name	=	''P7_DOREST_RESULTS''	',
'select		',
'jt1.category_name category_name',
'',
'from	apex_collections t,		',
'json_table(t.clob001, ''$.CATEGORY_NAME[*]'' COLUMNS rid for ordinality, category_name varchar2(255) path ''$'') jt1	',
'',
'where t.collection_name = ''P3_DOREST_RESULTS'''))
,p_source_type=>'NATIVE_SQL_REPORT'
,p_ajax_enabled=>'N'
,p_query_row_template=>wwv_flow_api.id(17152146155896338657)
,p_query_num_rows=>15
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(18042517505967123233)
,p_query_column_id=>1
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(18178645988297048095)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(18178645618106048094)
,p_button_name=>'SUBMIT'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(17152171256482338668)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(18178646338809048096)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18178647199856048101)
,p_name=>'P3_DB'
,p_item_sequence=>1
,p_item_plug_id=>wwv_flow_api.id(18178645618106048094)
,p_prompt=>'Db'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18178647967418048103)
,p_name=>'P3_USER'
,p_item_sequence=>2
,p_item_plug_id=>wwv_flow_api.id(18178645618106048094)
,p_prompt=>'User'
,p_source=>'C##cs347_zdb248'
,p_source_type=>'STATIC'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_cMaxlength=>255
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18178648742822048103)
,p_name=>'P3_PASS'
,p_item_sequence=>3
,p_item_plug_id=>wwv_flow_api.id(18178645618106048094)
,p_prompt=>'Pass'
,p_source=>'orcl_zdb248'
,p_source_type=>'STATIC'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_cMaxlength=>255
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18178649576714048104)
,p_name=>'P3_MODE'
,p_item_sequence=>4
,p_item_plug_id=>wwv_flow_api.id(18178645618106048094)
,p_prompt=>'Mode'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18178650343819048105)
,p_name=>'P3_MODEL'
,p_item_sequence=>5
,p_item_plug_id=>wwv_flow_api.id(18178645618106048094)
,p_prompt=>'Model'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18178651117582048105)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18178651987273048106)
,p_name=>'P3_RETURNFOR'
,p_item_sequence=>7
,p_item_plug_id=>wwv_flow_api.id(18178645618106048094)
,p_prompt=>'Returnfor'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18178652776933048107)
,p_name=>'P3_QUERY'
,p_item_sequence=>8
,p_item_plug_id=>wwv_flow_api.id(18178645618106048094)
,p_prompt=>'Query'
,p_source=>'"MATCH (a:category) RETURN a.category_name"'
,p_source_type=>'STATIC'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_cMaxlength=>255
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(18178646770238048098)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_WEB_SERVICE'
,p_process_name=>'Web Service Request'
...
wwv_flow_api.create_web_service(
 p_id=>wwv_flow_api.id(17152289909664350965)
,p_name=>'RestfulRel'
...
wwv_flow_api.create_ws_operations(
 p_id=>wwv_flow_api.id(17152290183765350977)
,p_ws_id=>wwv_flow_api.id(17152289909664350965)
,p_name=>'doREST'
);
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(17152290451690350982)
,p_ws_opers_id=>wwv_flow_api.id(17152290183765350977)
,p_name=>'query'
,p_input_or_output=>'I'
,p_parm_type=>'string'
,p_type_is_xsd=>'Y'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(17746497340537849033)
,p_parameter_id=>wwv_flow_api.id(17152290451690350982)
,p_process_id=>wwv_flow_api.id(17746490977810849021)
,p_map_type=>'ITEM'
,p_parm_value=>'P2_QUERY'
);
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(18178653110213048107)
,p_parameter_id=>wwv_flow_api.id(17152290451690350982)
,p_process_id=>wwv_flow_api.id(18178646770238048098)
,p_map_type=>'ITEM'
,p_parm_value=>'P3_QUERY'
);
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(17152290736578350984)
,p_ws_opers_id=>wwv_flow_api.id(17152290183765350977)
,p_name=>'json'
,p_input_or_output=>'O'
,p_parm_type=>'json'
...
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(17152295209631359366)
,p_ws_opers_id=>wwv_flow_api.id(17152290183765350977)
,p_name=>'DB'
,p_input_or_output=>'H'
,p_type_is_xsd=>'Y'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(17746491715961849027)
,p_parameter_id=>wwv_flow_api.id(17152295209631359366)
,p_process_id=>wwv_flow_api.id(17746490977810849021)
,p_map_type=>'ITEM'
,p_parm_value=>'P2_DB'
);
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(18178647530927048102)
,p_parameter_id=>wwv_flow_api.id(17152295209631359366)
,p_process_id=>wwv_flow_api.id(18178646770238048098)
,p_map_type=>'ITEM'
,p_parm_value=>'P3_DB'
...
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(17152295531018359366)
,p_ws_opers_id=>wwv_flow_api.id(17152290183765350977)
,p_name=>'USER'
,p_input_or_output=>'H'
,p_type_is_xsd=>'Y'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(17746492527937849029)
,p_parameter_id=>wwv_flow_api.id(17152295531018359366)
,p_process_id=>wwv_flow_api.id(17746490977810849021)
,p_map_type=>'ITEM'
,p_parm_value=>'P2_USER'
);
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(18178648352791048103)
,p_parameter_id=>wwv_flow_api.id(17152295531018359366)
,p_process_id=>wwv_flow_api.id(18178646770238048098)
,p_map_type=>'ITEM'
...
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(17152295849090359367)
,p_ws_opers_id=>wwv_flow_api.id(17152290183765350977)
,p_name=>'PASS'
,p_input_or_output=>'H'
,p_type_is_xsd=>'Y'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(17746493319333849030)
,p_parameter_id=>wwv_flow_api.id(17152295849090359367)
,p_process_id=>wwv_flow_api.id(17746490977810849021)
,p_map_type=>'ITEM'
,p_parm_value=>'P2_PASS'
);
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(18178649117118048104)
,p_parameter_id=>wwv_flow_api.id(17152295849090359367)
,p_process_id=>wwv_flow_api.id(18178646770238048098)
,p_map_type=>'ITEM'
...
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(17152296102023359367)
,p_ws_opers_id=>wwv_flow_api.id(17152290183765350977)
,p_name=>'MODE'
,p_input_or_output=>'H'
,p_type_is_xsd=>'Y'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(17746494180818849030)
,p_parameter_id=>wwv_flow_api.id(17152296102023359367)
,p_process_id=>wwv_flow_api.id(17746490977810849021)
,p_map_type=>'ITEM'
,p_parm_value=>'P2_MODE'
);
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(18178649906150048104)
,p_parameter_id=>wwv_flow_api.id(17152296102023359367)
,p_process_id=>wwv_flow_api.id(18178646770238048098)
,p_map_type=>'ITEM'
...
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(17152296464760359367)
,p_ws_opers_id=>wwv_flow_api.id(17152290183765350977)
,p_name=>'MODEL'
,p_input_or_output=>'H'
,p_type_is_xsd=>'Y'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(17746494946236849031)
,p_parameter_id=>wwv_flow_api.id(17152296464760359367)
,p_process_id=>wwv_flow_api.id(17746490977810849021)
,p_map_type=>'ITEM'
,p_parm_value=>'P2_MODEL'
);
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(18178650702886048105)
,p_parameter_id=>wwv_flow_api.id(17152296464760359367)
,p_process_id=>wwv_flow_api.id(18178646770238048098)
,p_map_type=>'ITEM'
...
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(17152296734386359367)
,p_ws_opers_id=>wwv_flow_api.id(17152290183765350977)
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(17746495778594849032)
,p_parameter_id=>wwv_flow_api.id(17152296734386359367)
,p_process_id=>wwv_flow_api.id(17746490977810849021)
,p_map_type=>'ITEM'
,p_parm_value=>'P2_RETURNDIMENSIONS'
);
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(18178651579113048106)
,p_parameter_id=>wwv_flow_api.id(17152296734386359367)
,p_process_id=>wwv_flow_api.id(18178646770238048098)
,p_map_type=>'ITEM'
...
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(17152297092029359367)
,p_ws_opers_id=>wwv_flow_api.id(17152290183765350977)
,p_name=>'returnFor'
,p_input_or_output=>'H'
,p_type_is_xsd=>'Y'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(17746496542415849033)
,p_parameter_id=>wwv_flow_api.id(17152297092029359367)
,p_process_id=>wwv_flow_api.id(17746490977810849021)
,p_map_type=>'ITEM'
,p_parm_value=>'P2_RETURNFOR'
);
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(18178652363008048106)
,p_parameter_id=>wwv_flow_api.id(17152297092029359367)
,p_process_id=>wwv_flow_api.id(18178646770238048098)
,p_map_type=>'ITEM'
